                    ...
                    <div className="header__menu ms-auto">
                        <ul className="header__nav mb-0">
                            ...
                            <li className="header__nav-item">
                                ...
                                <ul className="dropdown-menu header__nav-menu">
                                    ...
                                    <Link href="/exploretwo">
                                        <a className={router.pathname == "/exploretwo" ? "drop-down-item active" : "drop-down-item"}>All NFTs</a>
                                    </Link>
                            ...
                            <li className="header__nav-item">
                                ...
                                <Link href="/blogthree">
                                    <a className={router.pathname == "/blogthree" ? "drop-down-item active" : "drop-down-item"} href="blog-3.html">Blog</a>
                                </Link>
                                {/* <ul className="dropdown-menu header__nav-menu">
                                    <li>
                                    <Link href="/blog">
                            ...
                            <li className="header__nav-item">
                                ...
                                <ul className="dropdown-menu header__nav-menu">
                                    ...
                                    <Link href="/contacttwo">
                                        <a className={router.pathname == "/contacttwo" ? "drop-down-item active" : "drop-down-item"}>Contact</a>
                                    </Link>
                                    </li>
                                    <li>
                                    <Link href="/signin">
